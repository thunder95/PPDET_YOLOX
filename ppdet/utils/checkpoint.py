...
def load_pretrain_weight(model, pretrain_weight):
    ...
    # raw_keys = model_dict.keys()
    # load_keys = param_state_dict.keys()
    #
    # inters = list(set(raw_keys).intersection(load_keys))
    # print("debug: ---> ", len(raw_keys), len(load_keys), len(inters))
    #
    # tk_list = list(set(raw_keys).difference(set(load_keys)))
    # print(len(tk_list), tk_list)
    #
    # pk_list = list(set(load_keys).difference(set(raw_keys)))
    # print(len(pk_list), pk_list)
